...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //this is faulty part might burst later
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  const channel = await User.aggregate([
    ...
    {
      //done to know number of subscribers
      $lookup: {
        from: "subsciptions",
        localField: "_id",
        foreignField: "channel",
        as: "subscribers", //due to models name
      },
    },
    {
      //done to count number of channels user has subcribed to
      $lookup: {
        from: "subscriptions",
        localField: "_id",
